...
namespace NebulaPatcher.Patches.Dynamic
{
    ...
    class UIMainMenu_Patch
    {
        ...
        private static void AddMultiplayerButton()
        {
            ...
            OverrideButton(multiplayerButton, "多人游戏", OnMultiplayerButtonClick);
        }
        ...
        private static void AddMultiplayerSubMenu()
        {
            ...
            OverrideButton(multiplayerSubMenu.Find("button-multiplayer").GetComponent<RectTransform>(), "新的存档", OnMultiplayerNewGameButtonClick);
            OverrideButton(multiplayerSubMenu.Find("button-new").GetComponent<RectTransform>(), "读取存档", OnMultiplayerLoadGameButtonClick);
            OverrideButton(multiplayerSubMenu.Find("button-continue").GetComponent<RectTransform>(), "加入游戏", OnMultiplayerJoinGameButtonClick);
            OverrideButton(multiplayerSubMenu.Find("button-load").GetComponent<RectTransform>(), "返回主页", OnMultiplayerBackButtonClick);
        ...
        private static void AddMultiplayerJoinMenu()
        {
            ...
            OverrideButton(multiplayerMenu.Find("start-button").GetComponent<RectTransform>(), "加入游戏", OnJoinGameButtonClick);
        ...
        {
            InGamePopup.ShowInfo("Nebula中文版", $"正在加入中请稍后...", null, null);
            multiplayerMenu.gameObject.SetActive(false);
            ...
            if (!ConnectToServer(ip, port, isIP))
            {
                ...
                InGamePopup.ShowWarning("Nebula中文版", $"加入失败!请核实房主识别码!", "好的");
                multiplayerMenu.gameObject.SetActive(true);
            }
            else
            {
